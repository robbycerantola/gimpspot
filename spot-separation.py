...
#
# spot-separation.py V0.3 Copyright Robby Cerantola  2010-2011  robbycerantola@gmail.com
...
def rastering_separation(timg,tdrawable,palette="Default",multiple=False,threshold=26,wdir=os.getcwd()):
    ...
    for idxcol in range(0,nrcol-1):
        ...
        pdb.gimp_by_color_select_full(nwdrawable,color,int(threshold),0,0,0,0,0,0,0,4)
        pdb.gimp_edit_copy(nwdrawable)    
        floating=pdb.gimp_edit_paste(nwdrawable,0)
...
register(
        ...
        "Robby Cerantola",
        "2010-2011",
        "<Image>/Separation/_Prepare palette...",
        "RGB*, GRAY*",
        [
...
register(
        ...
        "You have to make a custom colour palette first",
        "Robby Cerantola",
        "Robby Cerantola",
        "2010-2011",
        "<Image>/Separation/_Spot-Separation...",
        "RGB*, GRAY*",
        [
...
register(
        ...
        "Robby Cerantola",
        "2010-2011",
        "<Image>/Separation/_Compute pixel enlargement...",
        "RGB*, GRAY*",
        [
...
register(
        "Rastering-separation",
        "Make a color separation using custom rastering",
        "",
        "Robby Cerantola",
        "Robby Cerantola",
        "2010-2011",
        "<Image>/Separation/_Rastering-Separation...",
        "RGB*, GRAY*",
        [
                (PF_PALETTE, "palette", "P_alette name:", "Default"),
                (PF_SLIDER,"threshold","Threshold",26,(0,255,1)),
                (PF_BOOL,   "multiple", "Multiple _files:", False),
                (PF_DIRNAME,"wdir","_Working directory",0)
